...
analysis_proper <- analysis_select |>
  ...
  marriage_cohort_cat = case_when(
    ...
    country == "Belgium" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    
    # Bulgaria: combine 2001-2010 with After 2010, then with 1991-2000
    country == "Bulgaria" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    ...
    country == "Croatia" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    ...
    country == "Finland" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    
    # France: combine all 1991 onwards
    country == "France" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    
    # Georgia: combine After 2000 with 1991-2000
    country == "Georgia" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    ...
    country == "Italy" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    ...
    country == "Lithuania" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    
    # Netherlands: keep as is (85 events is close to 100)
    ...
    country == "Romania" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    
    # Russia: combine all from 1991 onwards
    country == "Russia" & marriage_cohort_cat %in% c("1991-2000", "2001-2010", "After 2010") ~ "1991-2020",
    
    # Spain: combine After 2010 with 2001-2010
    country == "Spain" & marriage_cohort_cat %in% c("2001-2010", "After 2010") ~ "After 2000",
    
    # Sweden: keep as is (54 events, but might need combining if threshold is 100)
